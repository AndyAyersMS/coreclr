...
CompPhaseNameMacro(PHASE_MORPH_ADDFG,            "Morph - Add internal blocks",    "MOR-ADD",  false, -1, true)
...
CompPhaseNameMacro(PHASE_STR_ADRLCL,             "Morph - Structs/AddrExp",        "MOR-STRAX",false, -1, false)
CompPhaseNameMacro(PHASE_PROMOTE_STRUCTS,        "Morph - Promote Structs",        "MOR-STRPR",false, -1, false)
...
CompPhaseNameMacro(PHASE_MORPH,                  "Morph",                          "MORPH",    true,  -1, true)
